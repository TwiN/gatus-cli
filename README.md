...
## Installation
You can download the executable for your platform using the [releases page](https://github.com/TwiN/gatus-cli/releases).

Alternatively, if you have Go installed, you can install it via:
```console
